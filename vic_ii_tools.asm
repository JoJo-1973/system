...
; Titolo:                 Seleziona il banco di memoria visibile dal VIC-II
; Nome:                   VIC_BANK
...
; Titolo:                 Seleziona la posizione iniziale della memoria schermo
; Nome:                   VIC_SCREEN
...
; Titolo:                 Seleziona la posizione iniziale del generatore di caratteri
; Nome:                   VIC_CHRGEN
...
; Titolo:                 Seleziona la posizione iniziale della memoria ad alta risoluzione
; Nome:                   VIC_BITMAP
...
; Titolo:                 Sposta il generatore di caratteri in RAM
; Nome:                   MOVCHR
...
; Puntatori zp alterati:  ZP_1, ZP_2
; Temporanei alterati:    Nessuno
...
!macro Vic_Copy_CharGen {
  ...
  VIC_COPY_CHRGEN:
    ...
    sta ZP_1                ; ZP_1 = CHRGEN
    lda #>CHRGEN
    sta ZP_1+1

    lda #$00                ; ZP_2 = VICCHR*$1000
    sta ZP_2
    sec
    jsr VIC_CHARGEN
    sta ZP_2+1
  ...
  .Exit_VIC_COPY_CHRGEN:
    rts
  !zone
}

; Titolo:                 Abilita la modalità grafica bitmap
; Nome:                   BMPON
...
; Titolo:                 Disabilita la modalità grafica bitmap
; Nome:                   BMPOFF
...
; Titolo:                 Abilita la modalità colore esteso
; Nome:                   ECMON
...
; Titolo:                 Disabilita la modalità modalità colore esteso
; Nome:                   ECMOFF
...
; Titolo:                 Abilita la modalità grafica multicolore
; Nome:                   MCMON
...
; Titolo:                 Disabilita la modalità grafica multicolore
; Nome:                   MCMOFF
